            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="../assets/titanium-design.jpg" alt="iphone-titanium" />
                    ...
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src=".../assets/Iphone 17 Pro Max.jpg" alt="ios 2025" />
                ...
                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
                    ...
                    <img className="w-full rounded-2xl mb-4" src="../assets/iPhone 17 .jpg" alt="chip a18" />
